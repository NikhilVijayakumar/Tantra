...
- **Output:** One or more Markdown files (e.g., `README.md`, `use_cases.md`) based on complexity.
...
- **Output:** Architecture notes (e.g., `design.md`, `contracts.md`, `api_spec.md`).

### C. Unit Test Documentation (`docs/features/{module}/unittest/`)
- **Audience:** Developers / QA
- **Content:**
    - **Happy Path:** Standard success scenarios.
    - **Corner Cases:** Boundary values, nulls, invalid inputs.
    - **Code Coverage:** Strategy to hit branch coverage targets.
- **Output:** Multiple files (e.g., `happy_path.md`, `corner_cases.md`).

### D. E2E Test Documentation (`docs/features/{module}/e2etest/`)
- **Audience:** QA / Automation Engineers
- **Content:**
    - **Happy Path:** Critical User Journeys (CUJs).
    - **Corner Cases:** System error handling, network failures.
- **Output:** Multiple scenario files (e.g., `login_flow.md`, `payment_flow.md`).
