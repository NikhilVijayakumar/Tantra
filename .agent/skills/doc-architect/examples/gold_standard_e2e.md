...
**Prefix:** `AR` | **Location:** `docs/features/archiver/e2etest/e2e_test_scenarios.md`
...
| --- | --- | --- | --- |
| **AR-E2E-001** | **Standard Archival** | Check `.Tantra/logs/archive/` | A valid `.zip` file exists containing the original log data. |
