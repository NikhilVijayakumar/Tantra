...
The goal of logging in TANTRA is to allow a developer to look at a production log and immediately identify which **Blueprint ID** failed without opening the source code.
...
```python
from tantra.domain.protocols import LoggerProtocol
import logging
import os
