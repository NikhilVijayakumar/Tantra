---
name: refactor-agent
description: Uses TANTRA quality reports to identify and fix architectural drift, complexity spikes, and dependency cycles.
---
...
## 3. Implementation
1. Read the specific report file in `.Tantra/Report/`.
