...
## 🏛️ The Four Pillars of TANTRA Implementation
...
We treat `tantra` as a rigid, global namespace.

* **The Guardrail:** Every import is a full map coordinate (e.g., `from tantra.domain...`). Relative imports (`from .`) are strictly forbidden.
