### 📂 `.agent\skills\quality-manager\examples\nibandha_manager_resume_behavior.md`

# Quality Manager Orchestration: Resume & Fast-Forward Logic

The Quality Manager is **State-Aware** and **Environment-Locked**. It checks for the existence of the virtual environment and project artifacts before activating any agent. This prevents "Ghost Executions" and respects manual architectural overrides.
...
* **Source Discovery:** Parse `pyproject.toml` to identify the absolute `{root}` (e.g., `bavans/tantra`).
...
**User Action:** You manually edit `docs/features/auth/functional/README.md` to add custom logic.
**Input:** `"Quality Manager, create Auth"`
...
3. **Detection:** Target logic at `src/bavans/tantra/auth/core.py` is missing or fails quality gates.
...
| **1. Doc-Architect** | `docs/features/{module}/functional/README.md` | Existence & Size | **SKIP** (Log: "Blueprint Verified") |
