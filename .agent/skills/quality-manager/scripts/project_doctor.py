...
class ProjectDoctor:
    ...
    def _get_expected_prefix(self) -> str:
        ...
        try:
            ...
            # e.g. {"": "src/bavans"} means root is src/bavans, so packages are inside there
    ...
    def check_module(self, module_name: str):
        ...
        stages = [
            # Trinity Docs: docs/features/{module}/functional/README.md
            {"id": "Doc-Architect", "path": f"docs/features/{module_name}/functional/README.md", "validator": None},
            ...
            # Code: src/{prefix}/{module_name}/
            {"id": "Clean-Implementation", "path": f"src/{prefix}/{module_name}/", "validator": "pydantic"}
        ]
