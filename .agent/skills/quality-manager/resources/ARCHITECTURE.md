### 📂 `.agent\skills\quality-manager\resources\ARCHITECTURE.md`
...
* **Absolute Imports:** Use `from {root}.{module}` (e.g., `from bavans.jnanadeepa.archiver`).
...
│   └── {root}/          # Absolute Package Root (e.g., bavans/jnanadeepa)
