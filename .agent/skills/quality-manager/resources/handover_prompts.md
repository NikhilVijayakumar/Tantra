### 📂 `.agent\skills\nibandha-manager\resources\handover_prompts.md`

# Quality Manager: Handover Protocols
...
> 2. **Structure:** Create the physical test suite in `tests/{module}/`.
...
### 💡 Why this works for the "Quality Manager"
